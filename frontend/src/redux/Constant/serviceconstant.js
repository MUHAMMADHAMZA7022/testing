...
export const NEW_SERVICE_FAIL = "SERVICE_FAIL";
...
export const JOIN_SERVICE_REQUEST="JOIN_SERVICE_REQUEST";
export const JOIN_SERVICE_SUCCESS="JOIN_SERVICE_SUCCESS";
export const JOIN_SERVICE_FAIL="JOIN_SERVICE_FAIL";
export const JOIN_SERVICE_RESET="JOIN_SERVICE_RESET";
